...
### 阶段学习规划
#### L1：认知篇——理解大模型
- 核心内容：Python基础、大模型核心原理与认知、提示词工程
- 学习要求：建立坚持的大模型技术基础以及认知，知道市面上有哪些大模型以及对应产品，常见的行业落地方向，大模型的基础原理，强化Python编程能力，为后续转型奠定基础。
- 阶段目标：掌握大模型基础原理，能够编写高质量提示词，搭建AI开发环境。

#### L2:攻坚篇——RAG赋能大模型
- 核心内容：RAG、LanguageChain、LlamaIndex、Advanced RAG、RAG评估、Graph RAG等。
- 学习要求：掌握RAG核心技术，能够构建知识库系统，对大模型进行私有化知识的注入，怎么搭建，出现什么问题，怎么优化，怎么评估等等
- 阶段目标：能够构建基础RAG系统，掌握RAG常见的优化策略。

#### L3:跃迁篇——Agent开发实践
- 核心内容：Function calling、Agents、LangGraph、Agent IDE及多智能体项目实战。
- 学习要求：具备开发智能体的能力、能够构建自动化工作流，多Agent之间怎么去协作等等，这也是目前大模型落地最常见的场景。
- 阶段目标：能够独立开发Agent、多Agent应用，理解智能体框架的核心原理。

#### L4:微调大模型
- 核心内容：Transformer原理、开源大模型部署、模型评估量化、Fine-Tuning、多模态实战，
- 学习要求：根据业务场景的特殊需求通过微调模型定制垂类行业大模型；掌握模型量化技术来压缩模型的体积，多模态大模型的原理及实践。
- 阶段目标：掌握开源大模型部署、微调、量化等方法，能够根据业务需求定制模型的风格与大小，使模型能够更加适应业务场景的需求。

#### 学习成功秘诀
- 持续投入：每天保持学习、养成编码习惯。
- 实践为主：完成课程中每个项目实战，并主动尝试拓展应用场景。
- 主动交流：积极参与开源社区讨论，互相启发。
- 系统学习：按照课程规划循序渐进，筑牢每个基础内容。
- 作品积累：积累学习成果，打造个人项目作品集。
